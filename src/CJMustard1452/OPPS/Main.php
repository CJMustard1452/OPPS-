...
use CJMustard1452\OPPS\Entities\Spider\ClearSpidersTask;
use CJMustard1452\OPPS\Entities\Spider\Spider;
use CJMustard1452\OPPS\Entities\Spider\SpiderAI;
...
class Main extends PluginBase implements Listener{
	...
	public function onEnable() :Void{
		...
		$this->getScheduler()->scheduleRepeatingTask(new ClearSpidersTask($this), 20);
		new Config($this->getDataFolder() . "Toggles", Config::YAML);
		new Config($this->getDataFolder() . "Spider_Benz", Config::YAML);
	}
	public function onDisable(){
		unlink($this->getDataFolder() . "Toggles");
		unlink($this->getDataFolder() . "Spider_Benz");
	}
